...
public class DataUtil {
	...
	public static Object[][] getData(Xls_Reader xls,String testName)
	{
		...
		{
			System.out.println("rowStart data is:  "+xls.getCellData("Data", 0, rowStart));
			rowStart++;
		}
		System.out.println("The RowStart for the "+testName+" is : "+rowStart);
		...
		{
			System.out.println("rows data is:  "+xls.getCellData("Data", 0, dataStartRowNum+rows));
			rows++;
		}
		System.out.println("Total Number of rows in "+testName+" is : "+rows);
		...
		{
			System.out.println("rows data is:  "+xls.getCellData("Data", col, colStartRowNum));
			col++;
		}
